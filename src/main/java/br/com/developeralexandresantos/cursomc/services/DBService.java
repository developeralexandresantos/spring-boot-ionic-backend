...
import br.com.developeralexandresantos.cursomc.domain.Cidade;
import br.com.developeralexandresantos.cursomc.domain.Cliente;
import br.com.developeralexandresantos.cursomc.domain.Endereco;
import br.com.developeralexandresantos.cursomc.domain.Estado;
...
import br.com.developeralexandresantos.cursomc.domain.PagamentoComCartao;
import br.com.developeralexandresantos.cursomc.domain.Pedido;
import br.com.developeralexandresantos.cursomc.domain.Produto;
import br.com.developeralexandresantos.cursomc.domain.enums.EstadoPagamento;
import br.com.developeralexandresantos.cursomc.domain.enums.Perfil;
import br.com.developeralexandresantos.cursomc.domain.enums.TipoCliente;
import br.com.developeralexandresantos.cursomc.repositories.CategoriaRepository;
import br.com.developeralexandresantos.cursomc.repositories.CidadeRepository;
import br.com.developeralexandresantos.cursomc.repositories.ClienteRepository;
import br.com.developeralexandresantos.cursomc.repositories.EnderecoRepository;
import br.com.developeralexandresantos.cursomc.repositories.EstadoRepository;
...
import br.com.developeralexandresantos.cursomc.repositories.ProdutoRepository;
...
public class DBService {
    ...
    public void instantiateTestDatabase() throws ParseException {
        ...
        Cliente cli2 = new Cliente(null, "Ana Costa", "maria@gmail.com", "09220534053", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("123"));
        cli2.addPerfil(Perfil.ADMIN);

        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
        cli2.getTelefones().addAll(Arrays.asList("94883321", "34252625"));
